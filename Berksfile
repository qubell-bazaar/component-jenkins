...
cookbook "java", git: "https://github.com/socrata-cookbooks/java.git", ref: "v1.23.0"
cookbook "openssl", git: 'https://github.com/opscode-cookbooks/openssl.git', ref: "v1.1.0"
...
cookbook "cookbook_qubell_jenkins", git: 'https://github.com/qubell-bazaar/cookbook_qubell_jenkins.git', ref: "v0.1.3"
